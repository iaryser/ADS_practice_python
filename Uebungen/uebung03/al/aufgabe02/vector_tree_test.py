...
if __name__ == '__main__':
  ...
  if vt.size() != 0:
    raise Exception("Bad size: " + vt.size() + " != 0")
  ...
  if vt.size() != 1:
    raise Exception("Bad size: " + vt.size() + " != 1")
  if not vt.is_root(a):
  ...
  if  vt.size() != 2:
    raise Exception("Bad size: " + vt.size() + " != 2")
  ...
  if vt.size() != 3:
    raise Exception("Bad size: " + vt.size() + " != 3")
...
  
  ...
  if vt.size() != 6:
    raise Exception("Bad size: " + vt.size() + " != 6")
